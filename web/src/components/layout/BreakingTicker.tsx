...
export default function BreakingTicker({ items }: BreakingTickerProps) {
  ...
  return (
    <div role="region" aria-live="polite" aria-label="Breaking news" className="flex h-9 select-none items-center overflow-hidden bg-gradient-to-r from-[#0E7490] to-[#0891B2]">
